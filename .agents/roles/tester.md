...
| **Báo cáo** | Actual Results | Bug Reports / Verification | `docs/original/testing/reports.md` |
| **Báo cáo Kỹ thuật** | Test Suite Status | QA Summary (TRS-001) | `docs/architecture/technical_report.md` |
