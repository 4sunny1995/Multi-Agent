...
| :--- | :--- | :--- | :--- |
| **Khảo sát** | Folder Path / Repo | System Map + Discovery Report | `docs/original/architecture/discovery.md` |
| **Giải mã** | Legacy Source Code | Logic Logic Extraction | `docs/original/business/legacy-logic.md` |
| **Đề xuất** | Analysis Findings | Modernization Roadmap | `docs/original/architecture/roadmap.md` |
